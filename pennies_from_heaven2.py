...
dollar_change = 0 ;quarter_change = 0;dime_change = 0;nickel_change = 0;penny_change = 0

def change_maker(pennies):
    global p_remainder;global dollar_change; global quarter_change;global dime_change;global nickel_change;global penny_change
...
print(f"For {num_of_pennies}, you'll have {dollar_change} dollars, and {quarter_change} Quarters, and {dime_change} Dimes, and {nickel_change} Nickels, and {penny_change} Pennies")
